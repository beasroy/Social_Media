...
const Posting = ({ post, apiEndpoint }) => {
  ...
  return (
    ...
    >
      <label
        htmlFor="photo"
        className="flex gap-4 items-center text-teal cursor-pointer"
      >
        {watch("postPhoto") ? (
      ...
      <div>
        <label htmlFor="caption" className="text-teal">
          Caption
        </label>
        <textarea
          {...register("caption", {
      ...
      <div>
        <label htmlFor="tag" className="text-teal">
          Tag
        </label>
        <input
      ...
      <button
        type="submit"
        className="py-2.5 rounded-lg mt-10 bg-teal hover:bg-purple-blue text-light-1"
      >
        Publish
      </button>
    </form>
