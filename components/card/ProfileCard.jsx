    ...
    <div className="flex flex-col gap-9">
      <div className="flex justify-between items-start">
        <div className="flex gap-5 items-start">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-teal text-heading3-bold max-sm:text-heading4-bold">
            ...
            <div className="flex gap-7 text-small-bold max-sm:gap-4">
              <div className="flex max-sm:flex-col gap-2 items-center max-sm:gap-0.5">
                <p className="text-purple-blue">{userData.posts.length}</p>
                <p className="text-teal">Posts</p>
              </div>
              <div className="flex max-sm:flex-col gap-2 items-center max-sm:gap-0.5">
                <p className="text-purple-blue">{userData.followers.length}</p>
                <p className="text-teal">Followers</p>
              </div>
              <div className="flex max-sm:flex-col gap-2 items-center max-sm:gap-0.5">
                <p className="text-purple-blue">{userData.following.length}</p>
                <p className="text-teal">Following</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex gap-6">
        {tabs.map((tab) => (
          <Link
            className={`tab ${
              activeTab === tab.name ? "bg-teal" : "bg-dark-2"
            }`}
