...
export const POST = async(req,{params})=>{
    try {
        ...
        const user = await User.findOne({ clerkId: userId }).populate("posts savedPosts likedPosts following followers").populate({
            path: "likedPosts",
            model: "Post",
            populate: {
              path: "creator",
        ...
        console.log(error)
        return new Response("Failed to like/dislike the post",{status:500})
    }
